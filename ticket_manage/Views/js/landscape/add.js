...
// 表单验证
    ...
    $('#btn-add').click(function(){
        ...
        if(obj.validationEngine('validate')== true){
            $.post('index.php?c=landscape&a=save', obj.serialize(),function(data){
                ...
                if(typeof data.errors != 'undefined'){
                    ...
                    setTimeout("location.href='landscape_lists.html'", 3000);
                }
            },"json");
    ...
    $('#licence_id').click(function() {
        $('#licence-form1').ajaxSubmit({dataType: 'json',success: function(data){
            if(data.errors){
                ...
                $("input[name='licence_id']").val(data['data'][0]['id']);
            }
        }});
    });
