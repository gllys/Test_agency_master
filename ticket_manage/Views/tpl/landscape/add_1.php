                                    ...
                                    <ul class="padded separate-sections">
                                        ...
                                        <li class="input">
                                            <label>景区级别:<span class="note">*</span>
                                               ...
                                               <?php if($scenicInfo['landscape_level_id'] == 0){?>
                                               ...
                                               <?php }else{ if ($levelInfo){
                                                   foreach ($levelInfo as $level){
                                                       if ($level['id'] == $scenicInfo['landscape_level_id']){
                                                           echo "<br/>".$level['name'];
                                                       }
                                                   }
                                               } }  ?>
                                        ...
                                        <li class="input">
                                            <label>详细地址:<span class="note">*</span>
                                                <br/>
                                                <?php if(empty($scenicInfo['address'])){ ?>
                                    ...
                                    <ul class="padded separate-sections">
                                        <li class="input">
                                            <label>景区介绍:<span class="note">*</span>
                                                <?php if(empty($scenicInfo['biography'])){ ?>
