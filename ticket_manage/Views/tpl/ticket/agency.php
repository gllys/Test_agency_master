...
<?php if ($landscapesList): ?>
    <?php foreach ($landscapesList as $landscape): ?>
                                        <tr>
                                            ...
                                            <td class="center">
                                                        <?php if ($landscape['organization']['type'] == 'landscape'): ?>
                                                            <?php echo $landscape['poi']['name']; ?>
                                                        <?php else: ?>
                                                    <a href="<?php echo PI_UPLOADS_URL . '/' . $landscape['thumbnail']['url']; ?>" class="editable-empty thumbs">
                                                        <img src="<?php echo PI_UPLOADS_URL . '/' . $landscape['thumbnail']['url']; ?>" width="100" />
                                                    </a>
                                                         <?php endif; ?>
