...
<div class="main-content">
	...
	<div class="container-fluid padded">
		<div class="box">
			<div class="box-header"><span class="title"><i class="icon-zoom-in"></i> 编辑文档</span></div>
							...
							<ul class="padded separate-sections">
								...
								<li class="input"><br>
									<label>文档标题<strong class="status-error">*</strong><span class="note"></span>
										<input type="text" value="<?php echo $help['name']?>" data-prompt-position="topLeft" class="validate[minSize[2],maxSize[32]]" name="name" placeholder="">
									</label>
								</li>
								<li class="input">
									<label>内容<strong class="status-error">*</strong><span class="note"></span>
										<textarea rows="6" name="info" placeholder="" data-prompt-position="topLeft" class="validate[required,maxSize[10000]]"><?php echo $help['info']?></textarea>
									</label>
								</li>
							</ul>
						</div>
