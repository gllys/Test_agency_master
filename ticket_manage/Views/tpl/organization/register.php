...
<div class="box-header">
    <span class="title"><i class="icon-edit"></i> 供应商注册</span>
</div>
        ...
        <ul class="padded separate-sections">
            ...
            <li class="input">
                <label>联系人：<span class="note">*</span>
                    <input type="text" value="" data-prompt-position="topRight: -80" class="validate[required,minSize[2],maxSize[32]]" name="contact" placeholder="">
                </label>
            </li>
            <li class="input">
                <label>详细地址：<span class="note">*</span>
                    <input type="text" value="" data-prompt-position="topRight: -80" class="validate[required,minSize[6],maxSize[64]]" name="address" placeholder="">
                </label>
            </li>
            <li class="input">
            ...
            <li>
                <label>所在地区：<span class="note">*</span></label>
                <div class="row-fluid">
                    <div class="span4">
        ...
        <ul class="padded separate-sections">
            ...
            <li class="input">
                <label>企业名称：<span class="note">*</span>
                    <input type="text" value="" data-prompt-position="topRight: -80" class="validate[required]" name="name" placeholder="">
                </label>
            </li>
            <li class="input">
                <label>手机号码：<span class="note">*</span>
                    <input type="text" value="" data-prompt-position="topRight: -80" class="validate[required,custom[mobile]]" name="mobile" placeholder="">
                </label>
            </li>
            <li class="input">
            ...
            <li class="input">
                <label>供应商类别：<span class="note">*</span></label>
                <div class="row-fluid">
                        <div class="span4">
                            <input type="radio" class="icheck" name="sell_role" value="whole" checked>
                            <label>批发商</label>
                        </div>
                        <div class="span4">
                            <input type="radio" class="icheck" name="sell_role" value="scenic">
                            <label>景区</label>
                        </div>
                        <div class="span4"></div>
                </div>            
                <span class="note">警告：供应商类别选择后无法修改</span>
            </li>
        </ul>
    </div>
</div>
