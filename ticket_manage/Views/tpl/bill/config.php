                        ...
                        <table class="table table-normal">
                            <tbody>
                                <tr>
                                    <th>特殊供应商结算周期设置:</th>
                                    <td>
                                        <select class="uniform" name="account_cycle" id="account_cycle_0"  onchange="changeDayShowMore(this.value, 0)">
                                    ...
                                    <td>
                                        <select class="uniform" name="account_cycle_day" id="account_cycle_day_0">
                                    ...
                                    <td>
                                        <select class="chzn-select" placeholder=""  name="supply_id">
                                    ...
                                    <td>
                                        <button class="btn btn-blue" id="other-form-button">确定</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    </form>
                    <div  class="box-header" >特殊供应商结算周期设置列表</div>
                    <table class="table table-normal ">
                        <thead>   
                            ...
                            if ($list):
                                ...
                                foreach ($list as $item):
                                    ...
                                    <tr id="supply_<?php echo $item['org_id'] ?>">
                                        ...
                                        <td><?php
                                            $rs = Organizations::api()->show(array('id' => $item['org_id']));
                                        ...
                                        <td style="width:60px;">
                                            <a href="#" class="edit" onclick="singleEdit(<?php echo $item['org_id'] ?>,this);
                                                            return false;">编辑</a> 
                                                        <a href="#" class="save" style="display:none;"  onclick="singleSave(<?php echo $item['org_id'] ?>);
                                                            return false;">保存</a> 
                                            <a href="#"  onclick="singleDel(<?php echo $item['org_id'] ?>);
                                                            return false;" style="float: right;">删除</a>
                                        </td> 
...
<?php endfor; ?>
            ...
            $(function() {
                $('#other-form-button').click(function() {
                    ...
                    $.post('index.php?c=bill&a=saveSupplyConfig', $('#other-form').serialize(), function(data) {
                        if (data.errors) {
                            alert(data.errors[0]);
                            return false;
                        }
            ...
            function singleEdit($id,eventObj) {
                var _html = '';
                _html += '<select class="uniform" name="account_cycle" id="account_cycle_' + $id + '"  onchange="changeDayShowMore(this.value,' + $id + ')">';
                ...
                var default_option = '<select class="uniform" name="account_cycle_day" id="account_cycle_day_' + $id + '"><option value="">请选择结算日</option>';
            ...
            function  singleSave($id){
                 ...
                 if (account_cycle=== '') {
                    ...
                    $.post('index.php?c=bill&a=saveSupplyConfig', {account_cycle:account_cycle,account_cycle_day:account_cycle_day,supply_id:$id}, function(data) {
                        if (data.errors) {
                            alert(data.errors[0]);
                            return false;
                        }
           ...
           function singleDel($id){
               $.post('index.php?c=bill&a=saveSupplyConfig', {account_cycle:0,account_cycle_day:0,supply_id:$id}, function(data) {
                        if (data.errors) {
                            alert(data.errors[0]);
                            return false;
                        }
        ...
        <script src="Views/js/bill/config.js"></script>
    </body>
</html>
