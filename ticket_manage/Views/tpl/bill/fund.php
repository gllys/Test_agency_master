    ...
    <div class="box">
        <div class="box-header">
            <ul class="nav nav-tabs nav-tabs-left">
                <li class="active"><a href="/bill_fund.html">资产列表</a></li>
                <li class=""><a href="/bill_fund2.html">提现处理</a></li>
            </ul>
        </div>
        ...
        <div class="tab-content">
                    ...
                    <form action="/bill_fund.html" method="get">
                        <div class="row-fluid" style="margin-bottom:10px;">
                            ...
                            <select class="uniform" name="sel_name">
                                ...
                                <option value="1"  <?php echo (isset($data['get']['sel_name'])&&$data['get']['sel_name']=='1')?' selected="selected"':'';  ?>>操作者账号</option>
                                <option value="2"  <?php echo (isset($data['get']['sel_name'])&&$data['get']['sel_name']=='2')?' selected="selected"':'';  ?>>机构名称</option>
                            </select>
                    ...
                    <table class="table table-normal order-list">
                        ...
                        ?>
                            <tr>
                                ...
                                <td <?php echo $funds['trade_type']=='1'?($funds['pay_type']==0?'style="color:#cc3399"':'style="color:green"'):($funds['trade_type']=='2'?'style="color:#cc3399"':($funds['trade_type']=='3'?'style="color:green"':($funds['trade_type']=='4'?'style="color:red"':'style="color:#cc3399"')));?>>
                                     <?php echo $funds['trade_type']=='1'?($funds['pay_type']==0?'':'+'):($funds['trade_type']=='2'?'':($funds['trade_type']=='3'?'+':($funds['trade_type']=='4'?'-':'')));?><?php echo $funds['money'];?></td>
                                <td  <?php echo $funds['trade_type']=='1'?($funds['pay_type']==0?'style="color:#cc3399"':'style="color:green"'):($funds['trade_type']=='2'?'style="color:#cc3399"':($funds['trade_type']=='3'?'style="color:green"':($funds['trade_type']=='4'?'style="color:red"':'style="color:#cc3399"')));?>>
                                    <?php echo $funds['trade_type']=='1'?($funds['pay_type']==0?'平台支付':'在线支付'):($funds['trade_type']=='2'?'退款':($funds['trade_type']=='3'?'充值':($funds['trade_type']=='4'?'提现':'应收账款')));?></td>
            ...
            <div id="t2" class="tab-pane">
                    ...
                    <form action="/bill_fund.html" method="get">
                        <div class="row-fluid" style="margin-bottom:10px;">
                            ...
                            提现状态：<select class="uniform" name="status">
                                            ...
                                            <option value="1" <?php echo (isset($data['get']['status']) && $data['get']['status'] == '2') ? ' selected="selected"' : ''; ?>>驳回</option>
                                        </select>
                    ...
                    <table class="table table-normal order-list">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $fund['op_account'];?></td>
                                ...
                                <td class="status-success"><?php echo $fund['op_account'];?></td>
                                <td><?php echo $fund['op_account'];?></td>
                                <td><?php echo $fund['op_account'];?></td>
                            </tr>
                            <?php } }  ?>
                ...
                <div class="dataTables_paginate paging_full_numbers">
                    1-15条 共61条   <a href="/landscape_equipments.html?p=2 class="next paginate_button">下一页 ></a> <a href=/landscape_equipments.html?p=5 class="next paginate_button">尾页 >></a>            </div>
            </div>
