...
class HistoryController extends Controller {
    ...
    public function actionIndex($is_export = false) {
        ...
        // 获取景区id和名字的数组
        $rs = Landscape::api()->lists(array('organization_id' => $org_id, 'items' => 1000));
        ...
        $rs = Credit::api()->lists(array('supplier_id' => $org_id, 'items' => 1000));
