<?php
$this->breadcrumbs = array('结算管理', '供应商应收账款单查询');
?>
<style>
    .table-bordered th {
...
<div class="contentpanel">
	...
	<div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">供应商应收账款单查询</h4>
        </div>
        <div class="panel-body">
            <form class="form-inline" method="get" action="/finance/receivable/">
				...
				<div class="form-group">
                                    <input class="form-control" placeholder="请输入分销商名称"type="text" name="agency_name" value="<?php echo isset($_REQUEST['agency_name'])?$_REQUEST['agency_name']:""; ?>">
				</div>
                                 <div class="form-group">
...
{
    $('#finance-detail').html();
	$.get('/finance/receivable/detail?id='+$id,function(data){
