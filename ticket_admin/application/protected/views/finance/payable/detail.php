...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title">应付账款单明细</h4>
    </div>
    <div class="modal-body" style="padding:0;overflow-y: auto">
        ...
        <?php endif;?>
          ...
          <tr <?php if($detail['bill_amount'] == 0){echo "style='display:none'";}?>>
            <th>操作:</th>
            <td colspan="7">
                <a onclick="finace_upload_show('<?php echo $detail['id'];?>');" href="#finance-upload-show" class="btn btn-primary btn-sm" data-toggle="modal">确认打款</a>
            </td>
          </tr>
          <?php endif;?>
        </tbody>
