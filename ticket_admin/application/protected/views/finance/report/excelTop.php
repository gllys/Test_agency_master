...
<Worksheet ss:Name="Worksheet">
    <Table x:FullColumns="1" x:FullRows="1" ss:StyleID="Default" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="15">
        ...
        <Row ss:Height="24">
            ...
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">分销商名称</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">门票名称</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">所属景区</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">供应商名称</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">预订时间</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">支付时间</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">游玩时间</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">张数</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">单价</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">结算金额</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">订单类型</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">订单类别</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">支付方式</Data>
            </Cell>
            <Cell ss:StyleID="s10">
