        ...
        <div class="panel-heading">
            ...
            <div class="panel-body">
                <form id="query1Form" class="form-inline" method="post" >
                    <div class="form-group" style="margin-right:0;"><label>请选择分销商:</label></div>
        ...
        <div class="panel-heading">
            ...
            <div class="panel-body">
                <form class="form-inline" id="query2Form" method="post" >
                    <div class="form-group" style="margin-right:0;"><label>请选择产品:</label></div>
                        <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="form-group">
                            <select name="mouth" class="select2" data-placeholder="" style="width:150px;padding:0 10px;">
                                ...
                                <?php }
                                $year = date('Y', time());
                                for ($i=0; $i < 12; $i++) { /*if($i<$month) $disclass = 'readonly'; else $disclass ='';*/ ?>
                                <option <?php echo ( isset($param['mouth']) && $param['mouth'] == ($i+1) || !isset($param['mouth']) && $lastmouth==($i+1)) ? 'selected="selected" ':' '; /*echo $disclass;*/ ?> value="<?php if($i+1<10) $lit = '0'; else $lit= ''; echo $year.'-'.$lit.($i+1);?>"><?php echo $daxie[$i+1];?>月</option>
                                <?php } ?> 
                            </select>
                        </div>
                        <div class="form-group">
