<?php
$this->childNav = '/agency/account/addagency';
?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="" class="form-control validate[required]" tag="用户名" name="agencyname" id="agencyname" />
									</div>
                                </div>
                                <!-- form-group -->
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
										<input type="password" class="validate[required,minSize[6],maxSize[16]] form-control" tag="密码" name="password" id="password"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="" class="form-control validate[required]" tag="公司名称" name="name"/>
                                    </div>
                                </div>
                                <!-- form-group -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="" class="form-control validate[required]" tag="联系人" name="contact" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
										<input type="text" placeholder="" class="validate[required] form-control" tag="详细地址" name="address"/>
                                    </div>
                                </div>
                                <!-- form-group -->
