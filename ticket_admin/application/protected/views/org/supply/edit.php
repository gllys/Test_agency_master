                    ...
                    <form class="form-horizontal form-bordered" id="form-data-supply">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span class="text-danger">*</span>供应商状态</label>
                                    <div class="col-sm-6">
                                        <div class="rdio rdio-default">                    
                                            <input type="radio" checked="" id="radioDefault1" name="status" value="1" <?php if($organizations['status'] == '1'){ echo 'checked=checked';}?>>
                                            <label for="radioDefault1">启用</label>
                                        </div>
                                        <div class="rdio rdio-default">
                                            <input type="radio"  id="radioDefault2" name="status" value="0" <?php if($organizations['status'] == '0'){ echo 'checked=checked';}?>>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span class="text-danger">*</span>信用支付</label>
                                    <div class="col-sm-6">
                                        <div class="rdio rdio-default">                    
                                            <input type="radio" checked="" id="radioDefault3" name="is_credit" value="1" <?php if($organizations['is_credit'] == '1'){ echo 'checked=checked';}?>>
                                            <label for="radioDefault3">启用</label>
                                        </div>
                                        <div class="rdio rdio-default">
                                            <input type="radio"  id="radioDefault4" name="is_credit" value="0" <?php if($organizations['is_credit'] == '0'){ echo 'checked=checked';}?>>
                                            <label for="radioDefault4">禁用</label>
                                        </div>
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"><span class="text-danger">*</span>储值状态</label>
                                    <div class="col-sm-6">
                                        <div class="rdio rdio-default">                    
                                            <input type="radio" checked="" id="radioDefault5" name="is_balance" value="1" <?php if($organizations['is_balance'] == '1'){ echo 'checked=checked';}?>>
                                            <label for="radioDefault5">启用</label>
                                        </div>
                                        <div class="rdio rdio-default">
                                            <input type="radio"  id="radioDefault6" name="is_balance" value="0" <?php if($organizations['is_balance'] == '0'){ echo 'checked=checked';}?>>
                                            <label for="radioDefault6">禁用</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <label class="control-label"><?php echo $organizations['supply_type'] ? '景区' : '批发商'?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
...
//        }       
        ...
        $(this).hide();
        $('#load').show();
        $.post('/org/supply/edit/id/<?php echo $_GET['id'] ?>', $('#form-data-supply').serialize(), function(data) {
            if (data.errors) {
