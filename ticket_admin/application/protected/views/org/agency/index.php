...
<div class="contentpanel">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-inline" method="get" action="/org/agency/">
                            ...
                            foreach ($lists as $value):
                                ...
                                <tr class="status-pending" height="36px">
                                    ...
                                    <td style="text-align: left">
                                        ...
                                        <a  class="underline" href="/org/agency/view/id/<?php echo $value['id'] ?>/"><?php echo $value['name']; ?></a>
                                    </td>
                                    <td>
                                                <?php
                                    ...
                                    <td class="icon">
                                        <a href="/org/agency/staff/id/<?php echo $value['id'] ?>/"><i class="fa fa-user"></i></a>
                                    </td>
                                   ...
                                   <td>
                                       ...
                                       <a title="编辑" style="margin-left: 10px;" href="/org/agency/edit/id/<?php echo $value['id'] ?>/">编辑</a>
                                  </td>
                                </tr>
...
//市切换
        ...
        //审核
         $('.btn-verify').click(function() {
                    ...
                    $.post('/org/agency/verify/', {id: id, status: status}, function(result) {
                        if (result == 1) {
