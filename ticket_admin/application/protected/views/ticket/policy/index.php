    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <button class="btn btn-primary btn-sm pull-right" data-target=".bs-example-modal-static" data-toggle="modal" onclick="add_rule(0)">新建分销商策略</button>
                分销策略
            </h4>
        </div>
            ...
            <form class="form-horizontal form-bordered" id="repass-form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" tag="分销策略名称"  class="form-control validate[required,maxSize[20]]" maxlength="20" value="" id="pname" name="pname">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">分销策略说明:</label>
                        <div class="col-sm-10">
                            <textarea tag="分销策略说明" class="form-control validate[maxSize[50]]" rows="5" maxlength="50" id="note" name="note"></textarea>
                        </div>
                    </div>
                    <table class="table table-bordered mb30" style="width: 976px !important;">
                        <tbody>
                            <tr style="background-color:#f7f7f7;">
                                ...
                                <td style=""><input id="blacknameAll" type="checkbox" value="" name="">&nbsp;<label for="blacknameAll">不允许购买</label></td>
                                <td style=""><label style="margin-right: 4px;">散客结算价</label><input type="text" name="daystorage" class="spinner form-control"></td>
                                <td style=""><label style="margin-right: 4px;">团购价</label><input type="text" name="daystorage" class="spinner form-control">
                                </td><td style=""><input id="" type="checkbox" value="" name="">&nbsp;<label for="creditAll">不允许信用支付</label></td>
                                <td style=""><input id="" type="checkbox" value="" name="">&nbsp;<label for="creditAll">不允许储存支付</label></td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <table class="table table-bordered mb30">
                            <tbody id="distributor">
                                <tr>
                                    ...
                                    <td style="width:116px;"><input id="p_176" type="checkbox" value="176" name="blackname_arr[176]" class="blackgroup"></td>
                    ...
                    <table class="table table-bordered mb30">
                        <tbody id="otherdist">
                            <tr style="background-color:#f7f7f7;">
                                ...
                                <td style="width:200px;"><input type="text" class="spinner-day"></td><td><input type="text" class="spinner-day"></td></tr></table>
                </div>
