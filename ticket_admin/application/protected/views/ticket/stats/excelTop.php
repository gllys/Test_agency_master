...
use common\huilian\utils\Format;
    $file_name = "景区统计详情_".Format::date(time())."_".rand(100000, 999999);
...
<Worksheet ss:Name="Worksheet">
    <Table x:FullColumns="1" x:FullRows="1" ss:StyleID="Default" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="15">
        ...
        <Row ss:Height="24">
            ...
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">销售数量</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">销售额</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">入园数</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">退票数</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">退票总额</Data>
            </Cell>
        </Row>