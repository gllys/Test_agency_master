                                ...
                                <div class="panel-body nopadding">
                                    <form action="/ticket/template/save" method="post" id="scenic_add_form"  id="form-data-supply">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input type="text" placeholder="" data-prompt-position="centerLeft" class="form-control validate[required,custom[chinese],custom[NoSp],minSize[1],maxSize[20]]" name="name" value="<?php echo $name; ?>" />
													</div>
												</div>
												<!-- form-group -->
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
				                                        <select class="select2 form-control validate[required]" name="scenic_id">
				                                            ...
				                                            <option <?php echo $v['id']==$landscape_id ? 'selected="selected"' : '';?> value="<?php echo $v['id'];?>" ><?php echo $v['name'];?></option>
				                                            <?php endforeach;?>
				                                        </select>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input type="text" placeholder="" class="form-control validate[required,maxSize[20]]" name="size" value="<?php $size= (isset($height) ? $height : "")."*".(isset($width) ? $width : "");echo isset($size) ? $size : '' ?>" /> <span style="color:red;">请输入您的门票的高度与宽度（宽度指垂直于打印机出纸方向）（单位：mm），例如：100*200，高度在前面</span>
													</div>
												</div>
												<!-- form-group -->
														...
														<div class="dropzone" id="preview_license">
															<div  id="preview"  class="fallback nailthumb-container square-thumb">
																<img id="preview_img"  src="<?php if(!empty($image)){echo $image;} else {?>/img/uploadfile.png<?php }?>" style="width:150px;height:150px;position:absolute;left:0px;top:0px"> 
																 <input type="hidden"  value="<?php if(!empty($image)){echo $image;} ?>" class="sp_sxming" name="preview" />
															</div>
														</div>
													</div>
												</div>
                                        ...
                                        <div class="panel-footer" style="padding-left:5%">
                                            <button class="btn btn-primary mr20" id="btn-add">确认修改</button>
                                        </div>
