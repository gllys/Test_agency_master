<?php
    $file_name = (($type=="whole")?"供应商":"景区")."统计详情";
...
<Worksheet ss:Name="Worksheet">
    <Table x:FullColumns="1" x:FullRows="1" ss:StyleID="Default" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="15">
        ...
        endforeach;
         ...
         if (isset($lists['data'])):
            $num = count($lists['data']);
        ?>
        <Row ss:Index="<?=$num+4;?>" ss:StyleID="s7">
            <Cell ss:StyleID="s18" ss:MergeAcross="255">
                <ss:Data ss:Type="String" xmlns="http://www.w3.org/TR/REC-html40"><Font html:Color="#000000">合计：共<?=$num;?>条</Font></ss:Data>
            </Cell>
        </Row>
        <?php
        endif;
