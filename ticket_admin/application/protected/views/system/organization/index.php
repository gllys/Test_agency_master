                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="" class="validate[required] form-control" maxlength="20" placeholder="请输入机构名称" tag="机构名称" name="name" value="<?php echo $organizations['name'] ?>" />
