    ...
    <![endif]-->
     ...
     <style>
        ...
        *,*:after,*:before{box-sizing: border-box;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;-ms-box-sizing: border-box;-o-box-sizing: border-box;}
        ...
        .hezuo .inner-bg{height:440px;background:url(/img/hezuo.png) no-repeat ;background-position:50% 70px;}
    ...
    <div class="new-bigBanner">
        ...
        <div class="new-inner">
            <div class="panel-signin">
                <ul class="nav-tabs2 hide">
                    <li style="margin-right:17px;"><a href="<?php $r = Yii::app()->getParams();echo $r['agencyUrl']?>/site/login">分销商登录</a></li>
                    <li class="active" ><a href="#supplier">供应商登录</a></li>
                </ul>
                <div class="panel-body">
                    <form action="" method="post" id="login-form">
                        <div class="input-group mb20 input-group1">
                            <label style="color: #ffffff">用户名</label>
                            <input class="validate[required]" autocomplete="off" type="text" name="ULoginForm[username]">
                        </div>
                        <div class="input-group mb15 input-group2">
                            <label style="color: #ffffff">密码</label>
                            <input class="validate[required]" autocomplete="off" type="password" name="ULoginForm[password]">
                        </div>
                        <div class="clearfix">
