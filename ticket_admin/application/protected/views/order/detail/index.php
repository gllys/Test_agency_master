...
<?php endif;?> -->
			...
			<div class="table-responsive mb10">
				...
				<tbody>
				  ...
				  <tr <?php echo in_array($detail['status'],array('paid','finish','billed'),true)? '' : 'hidden'; ?>>
					  <th>支付时间：</th>
					  <td><?php echo date("Y年m月d日 H时i分s秒",$detail['pay_at']);?></td>
                                    </tr>
                                  <tr <?php echo in_array($detail['status'],array('paid','finish','billed'),true)? '' : 'hidden'; ?>>
					  <th>支付方式：</th>
				  ...
				  <tr>
					  <th>预定时间：</th>
					  <td><?php echo date('Y年m月d日 H时i分s秒',$detail['created_at'])?></td>
                                  </tr>
                                     <tr>
					  <th>游玩时间：</th>
		...
		<div class="col-sm-6">
			<div class="panel panel-default">
			  ...
			  <table class="table table-bordered">
				<thead>
				<tbody>
				  <?php $agencyInfo = Organizations::api()->show(array('id' => intval($ticketFirst['distributor_id'])));?>  
				  <tr>
		...
		<div class="col-sm-6">
			<div class="panel panel-default">
			  ...
			  <table class="table table-bordered">
				<thead>
				<tbody>
				  <?php $supplyInfo = Organizations::api()->show(array('id' => $ticketFirst['supplier_id']));?> 
				  <tr>
	...
	<div class="panel panel-default">
		...
		<td><?php echo $ticketFirst['remark']?></td>
		</tr>
		</tbody>
		</table>
	</div>	
