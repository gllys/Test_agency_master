...
(function ($) {
    ...
    var methods = {
        ...
        _validateField: function (field, options, skipAjaxValidation) {
            ...
            if (!isAjax) {//options.eventTrigger
        ...
        _creditCard: function (field, rules, i, options) {
            ...
            if (!valid)
                return options.allrules.creditCard.alertText.replace('{tag}', field.attr("tag"));
        },
        /**
            ...
            if (!options.isError && !methods._checkAjaxFieldStatus(field.attr("id"), options)) {
                $.ajax({
                    ...
                    error: function (data, transport) {
                        ...
                        if (options.onAjaxFieldsComplete) {
                            options.onAjaxFieldsComplete(field.attr("id"), false);
                        }
                    },
                    success: function (json) {
                        ...
                        if (errorField.length == 1) {
                            ...
                            if (!status) {
                                ...
                                if (options.onAjaxFieldsComplete) {
                                    options.onAjaxFieldsComplete(field.attr("id"), true);
                                }
                            }
                            methods._handleStatusCssClasses(field, options);
