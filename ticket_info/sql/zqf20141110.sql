...
CREATE TABLE `ticket_discount_rule` (
  ...
  `discount` varchar(30) COLLATE utf8_unicode_ci NOT NULL COMMENT '优惠减免',
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='票的分销商限制名单';
