...
CREATE TABLE `subscribes` (
  ...
  `type` smallint(1) NOT NULL COMMENT '0:团客，1：散客',
  PRIMARY KEY (`id`),
  UNIQUE KEY `ticket_id` (`ticket_id`,`organization_id`,`type`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;


ALTER TABLE `ticket_info`.`ticket_discount_rule` CHANGE `discount` `fat_discount` DECIMAL(10,2) DEFAULT 0.00 COMMENT '散客优惠减免', ADD COLUMN `group_discount` DECIMAL(10,2) DEFAULT 0.00 COMMENT '团客优惠减免' AFTER `fat_discount`;
