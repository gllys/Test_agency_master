...
// base
define('SET_DOMAIN', 'ticket-api-info.piaotai.com');
define('SET_URL', 'http://ticket-api-info.piaotai.com');
...
define('SET_DB', serialize(array(
	// 'itourism' => array('host' => '192.168.1.248', 'user' => 'dbaroot', 'password' => 'dbaroot20090606', 'database' => 'ticket_info', 'port' => '3306'),
	// 'log' => array('host' => '192.168.1.248', 'user' => 'dbaroot', 'password' => 'dbaroot20090606', 'database' => 'ticket_log', 'port' => '3306'),
	'itourism' => array('host' => 'rdseeyivej2eaqa.mysql.rds.aliyuncs.com', 'user' => 'fx', 'password' => 'c3f9558d', 'database' => 'ticket_info', 'port' => '3306'),
...
// define('SET_USE_MEMCACHED', false);
// adefine('SET_MEMCACHE', serialize(
//    array(
//        'default' => array(
