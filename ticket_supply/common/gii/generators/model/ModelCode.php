...
class ModelCode extends CCodeModel
{
	...
	public $baseClass='UActiveRecord';
	...
	public function rules()
	{
		return array_merge(parent::rules(), array(
			array('tablePrefix, baseClass, tableName, modelClass, modelPath, isGlobal, connectionId', 'filter', 'filter'=>'trim'),
	...
	public function getDb(){
		...
		if(isset(Yii::app()->$db)) return Yii::app()->$db;
		else return null;
	}
