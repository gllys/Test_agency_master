 ...
 * @property string $sell_role
 * @property string $msg_rdy
...
class Users extends UActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, account, password, password_str, name, sell_role, msg_rdy, organization_id, landscape_id, gender, email, mobile, telephone, birthday, identity, position, biography, status, created_by, created_at, updated_at, deleted_at, is_super, is_guide, last_updated_source, is_weixin', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
        ...
        $criteria->compare('msg_rdy',$this->msg_rdy,true);
