        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title"><?php echo $source;?>查看分销商信息</h4>
                </div><!-- panel-heading -->
                <form class="form-horizontal form-bordered" id="repass-form">
                    <input value="single" type="hidden" name="type">
                    <div class="panel-body nopadding">
                        <?php if($_GET['source'] == 1):?>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">分销商用户名：</label>
                            <div class="col-sm-4" style="margin-top:5px">
                                <?php
                                 $listAngecys= AgencyUser::api()->Search(array('organization_id'=>$lookd['id']));
                                echo $listAngecys['message'] ['account'];
                                ?></div>
                        </div><!-- form-group -->
                        <?php endif;?>
                        <div class="form-group">
