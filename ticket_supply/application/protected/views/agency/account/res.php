                ...
                <div class="panel-body nopadding">
                    <div class="form-inline">
                        <div class="form-group">
                            <input class="form-control" placeholder="请输入分销商" style="width:200px;" type="text" name="name" value="<?php echo isset($agency_name) ? $agency_name : '' ?>">

                        </div>
                        <div class="form-group row">
                            <div class="col-md-4" style="width:150px">
                                <select class="select2"  data-placeholder="Choose One" id="province" name="province_id" style="width:130px;height:34px;">
                            ...
                            <div class="col-md-4" style="width:150px">
                                ...
                                <select class="select2" id="city" name="city_id" style="width:130px;height:34px;">
                            ...
                            <div class="col-md-4" style="width:150px">
                                <select class="select2" id="area" name="district_id" style="width:130px;height:34px;">
