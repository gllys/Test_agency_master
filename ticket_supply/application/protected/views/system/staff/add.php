                ...
                <div class="panel-body nopadding">
                    ...
                    <form class="form-horizontal form-bordered " id="repass-form" method="post" action="">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" placeholder="" class="validate[required] form-control" name="account" id="account" autocomplete="off" value=""/>
                            </div>
                            <label class="col-sm-2 control-label"><span class="text-danger">*</span> 密码</label>
                            <div class="col-sm-4">
	                            <input type="hidden"/>
	                            <input type="password" style="display: none"/>
                                <input type="password" placeholder="" class="validate[required,minSize[6],maxSize[16]] form-control" name="password" id="password" autocomplete="off" value=""/>
                            </div>
                        </div><!-- form-group -->
