                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" placeholder="" tag="密码" data-validation-engine="form-control  validate[required,minSize[6],maxSize[16]]" class="form-control  validate[required,minSize[6],maxSize[16]]" onclick="this.name='password'" />
                                    </div>
                                </div>
                                <!-- form-group -->
