<?php
$this->breadcrumbs = array('系统管理','消息查看');
?>
	...
	<div class="row">
		<div class="col-sm-3 col-md-3 col-lg-2">
			...
			<ul class="nav nav-pills nav-stacked nav-msg">
				<li class="<?php  if($type === null && $sms_type === null){ echo 'active';}else{echo '';} ?>">
					<a href="/system/message/all">
						<!--span class="badge pull-right"></span-->
						<i class="glyphicon glyphicon-inbox"></i> 全部消息
					</a>
				</li>
				<li class="<?php if($sms_type === 0 && $type === null){ echo 'active';}else{echo '';}  ?>"><a href="/system/message/org/"><i
							class="glyphicon  glyphicon-briefcase"></i> 系统消息</a></li>
				<li class="<?php if($sms_type == 1 && $type === null){ echo 'active';}else{echo '';} ?>"><a href="/system/message/ord/"><i
							class="glyphicon glyphicon-tower"></i> 订单消息</a></li>
				<li class="<?php if($type == 3 && $sms_type == null){ echo 'active';}else{echo '';} ?>"><a href="/system/message/rem/"><i
				...
				<?php if ($messages) : foreach ($messages as $message) : ?>
					<li id="message<?php echo $message{'id'} ?>" class="media <?php echo $message['read_time'] == 0 ? 'unread' : '' ?>">
						...
						<div class="media-body">
							...
							<?php //todo optimize
							$result = Organizations::api()->show(array('id' => $message['send_organization']));
							...
							?>
							<span class="text-<?php echo $sms_class[$message['sms_type']]?>">（<?php echo $sms_label[$message['sms_type']]?>）</span>
							</h4>
