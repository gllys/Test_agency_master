<div class="contentpanel">
		...
		<div class="panel-content"><div class="panel-header">
			...
			<div class="panel panel-default">
				...
				<div class="panel panel-default">
						...
						<td>
							<div class="dropzone">
								<div class="fallback" <?php echo $detail['payed_img'] ?  '' : 'disabled'?> >
									<a href="<?php echo $detail['payed_img'] ?  $detail['payed_img'] : '/img/nopic.png'?>" rel="prettyPhoto[gallery]" class="item-media" >
				  ...
				  <div class="panel-footer">
					<a class="btn btn-primary" id="bill_finish" <?php if($detail['receipt_status'] == 1 || $detail['pay_status'] == 0){echo "style='display:none'";} ?>>确认收款</a>
					<a class="btn btn-default" href="/finance/bill" >返回</a>
				  </div>
				</div>
		<?php endif;?>		
		</div>
...
jQuery(document).ready(function() {
	$('#bill_finish').click(function(){
		...
		$.post('/finance/detail/finish',{ id: $('input[type=hidden]').val()},function(data){
			if(data.error===0){
                    alert(data.msg);
                    window.location.href = '/finance/bill';
                }else{
                    alert(data.msg);
                }
            },'json')
