...
use common\huilian\utils\Format;
    $file_name = "交易流水_".Format::date(time())."_".rand(100000, 999999);
...
<Worksheet ss:Name="Worksheet">
    <Table x:FullColumns="1" x:FullRows="1" ss:StyleID="Default" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="15">
        ...
        <Column ss:StyleID="Default"  ss:AutoFitWidth="0" ss:Width="100"/>
        <Column ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="170"/>

        <Row ss:Height="24">
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">交易日期</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">操作人</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">交易类型</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">交易状态</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">交易金额</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">交易流水号</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">备注（结算单号）</Data>
            </Cell>
        </Row>