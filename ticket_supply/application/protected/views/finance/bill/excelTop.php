...
<Worksheet ss:Name="Worksheet">
    <Table x:FullColumns="1" x:FullRows="1" ss:StyleID="Default" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="15">
        ...
        <Column ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="151"/>
        <Column ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="100"/>
        <Column ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="100"/>
        <Column ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="100" ss:Span="1"/>
        <Column ss:Index="8" ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="100"/>
        <Column ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="100"/>
        <Column ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="100"/>
        ...
        <Row ss:Height="24">
            ...
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">账单生成日期</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">账单类型</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">应付金额</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">订单张数</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">支付状态</Data>
            </Cell>
            <Cell ss:StyleID="s10">
                <Data ss:Type="String">操作状态</Data>
            </Cell>
        </Row>