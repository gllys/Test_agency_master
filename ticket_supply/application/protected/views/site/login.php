        ...
        <section>
	        ...
	        <div class="panel panel-signin">
		        ...
		        <ul class="nav nav-tabs nav-justified">
			        <li><a href="<?php $r = Yii::app()->getParams();echo $r['agencyUrl']?>/site/login"><strong>分销商登录</strong></a></li>
			        <li class="active"><a href="#supplier" data-toggle="tab"><strong>供应商登录</strong></a></li>
		        </ul>
		        <!-- Tab panes -->
		        <div class="panel-body">
			        ...
			        <form action="" method="post" id="login-form">
				        ...
				        <div class="input-group mb15">
					        ...
					        <input type="password" class="form-control" name="ULoginForm[password]"
					               autocomplete="off">
				        </div>
				        <!-- input-group -->
		        ...
		        <div class="panel-footer">
			        <div class="tab-content" style="padding: 0">
				        ...
				        <div class="tab-pane active" id="supplier">
					        <a href="/site/register/" class="btn btn-primary btn-block">还没有账号？现在申请创建供应商账号</a>
				        </div>
				        <!-- supplier -->
			        </div>
