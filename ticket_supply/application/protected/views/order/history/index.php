			...
			<form class="form-inline" method="get" action="/order/history/view">
				<div class="mb10">
					<div class="form-group" style="margin:0">
                                            <input style="cursor: pointer;cursor: hand;background-color: #ffffff" name="start_date" class="form-control datepicker" type="text" readonly="readonly" value="<?php echo isset($get['start_date']) ? $get['start_date'] : date('Y-m-01',time());?>"> ~
                                            <input style="cursor: pointer;cursor: hand;background-color: #ffffff" name="end_date" class="form-control datepicker"  type="text" readonly="readonly" value="<?php echo isset($get['end_date']) ? $get['end_date'] :date('Y-m-d',time())?>">
					</div>
					<!-- form-group -->
					...
					<div class="input-group input-group-sm mb15">
						<div class="input-group-btn">
							...
							<ul class="dropdown-menu" role="menu">
								...
								<li><a class="sec-btn" href="javascript:;" data-id="ticket_name" id="" aria-labelledby="search_label">门票名称</a></li>
