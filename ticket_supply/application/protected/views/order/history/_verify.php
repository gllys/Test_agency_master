...
<?php if (isset($lists['data'])) : foreach ($lists['data'] as $order) : ?>
                                    <tr>
                                        ...
                                        <td style="width:9%"><?php echo $order['owner_name'] ?></td>
                                        ...
                                        <td style="width:9%"><?php echo $order['nums'] ?></td>
                                        <td style="width:9%"><?php echo number_format($order['amount'], 2) ?></td>
                                        <td style="width:9%" class="text-<?php echo Order::$auditStatusStyle[$order['audit_status']] ?>"><span><?php echo Order::$auditStatus[$order['audit_status']]; ?></span></td>
