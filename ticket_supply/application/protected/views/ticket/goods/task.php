    ...
    <div class="media">
        ...
        <div class="media-body">
            <ul class="breadcrumb">
                ...
                <li><a href="javascript:void(0)">发布任务单</a></li>
            </ul>
        </div>
    </div><!-- media -->
</div><!-- pageheader -->
                ...
                <form class="form-horizontal form-bordered" id="repass-form">
                    ...
                    <div class="panel-body nopadding">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="col-sm-3"><input type="text" placeholder="团队结算价" class="validate[required,custom[number]] form-control" name="group_price"/></div>
                                <div class="col-sm-3">
