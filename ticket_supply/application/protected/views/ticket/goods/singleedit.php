                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="rdio rdio-default inline-block">
                                    <input type="radio" value="1" id="radioDefault5" name="refund" <?php if($ticket['refund']==1){echo 'checked="checked"'; }?>>
                                    <label for="radioDefault5">是</label>
                                </div>
                                <div class="rdio rdio-default inline-block">
                                    <input type="radio" value="0" id="radioDefault6" name="refund" <?php if($ticket['refund']==0){echo 'checked="checked"'; }?>>
...
jQuery(document).ready(function() {
 $('#btnreset').click(function(){
    ...
    $('#distributor-select').ready(function(){
             ...
             $.post('/ticket/goods/singleedit',{'ids':names,'view':"<?php echo $ticket['view_point'];?>"},function(data){
                 $('#appendto').html(data);
             },'json');
        });
