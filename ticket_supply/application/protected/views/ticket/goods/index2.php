...
<div class="contentpanel">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-inline" method="get" action="/ticket/goods/index2">
                <div class="form-group">
                    <select data-placeholder="Choose One"  style="width:143px;height:32px;" id="distributor-select-search" name="scenic_id">
...
<button class="btn btn-primary btn-sm pull-right now" data-target=".modal-bank" data-toggle="modal" onclick="modal_jump_add();" style="margin:5px 15px 0 0">新增门票</button>
    <ul class="nav nav-tabs">
        <li class=""><a href="/ticket/goods/index" class="now1"><strong>基础门票</strong></a></li>
        <li class="active"><a href="/ticket/goods/index2" class="now2"><strong>我的门票</strong></a></li>
    </ul>
<script>
$(".now1").click(function(){
    $(".now").addClass("hide");
                            ...
                            <tr>
                                <td>
                                    ...
                                    if (!isset($_landscapes)) { //单例
                                        $lanIds = PublicFunHelper::arrayKey($lists, 'scenic_id');
