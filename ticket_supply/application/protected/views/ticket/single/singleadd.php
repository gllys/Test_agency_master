                ...
                <div class="form-group">
                    <div class="col-sm-2 control-label">
                        <div class="ckbox ckbox-primary pull-right">
                            <input type="checkbox" name="is_fit" type="checkbox" class="onlyMoney" value="1"  id="checkboxPrimary23" style="vertical-align: middle;">
                    ...
                    <div class="col-sm-2">
                        <div class="rdio rdio-default inline-block">
                            <input type="radio" checked="checked" value="1" name="is_fat_once_verificate" disabled="disabled" id="is_fat_once_verificate1">
                            <label for="is_fat_once_verificate1">是</label>
                        </div>
                        <div class="rdio rdio-default inline-block">
                            <input type="radio" checked="checked" value="0" name="is_fat_once_verificate" disabled="disabled" id="is_fat_once_verificate0">
                    ...
                    <div class="col-sm-2">
                        <div class="rdio rdio-default inline-block">
                            <input type="radio" value="1"  name="is_fat_once_taken" disabled="disabled" id="is_fat_once_taken1">
                            <label for="is_fat_once_taken1">是</label>
                        </div>
                        <div class="rdio rdio-default inline-block">
                            <input type="radio" checked="checked" value="0" name="is_fat_once_taken" disabled="disabled" id="is_fat_once_taken0">
...
景区扫二维码入园，您可以开启此功能，开启后，在A景区验证换实体票后，其他景区不可以再扫二维码。"></i>
                ...
                <div class="form-group" id="shio">
                    ...
                    <div class="col-sm-10">
                        <label class="pull-left" style="margin-top: 5px;">需在入园前&nbsp;</label> <input type="text"  tag="散客提前预定时间" class="spinner-day form-control validate[custom[number]]" value="" name="fat_scheduled" style="cursor: pointer;cursor: hand;background-color: #ffffff"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/> 天的
                        <div class="bootstrap-timepicker inline-block input-group" style="vertical-align:middle"><input id="timepicker2" tag="散客提前预定时间" type="text" value="" class="form-control" name="fat_scheduledtime" style="width:50px"></div>
                        以前购买
                    </div>
                </div><!-- form-group -->
                <div class="form-group" id="shide">
                    ...
                    <div class="col-sm-10">
                        <textarea id="fat_des" name='fat_description' placeholder="请输入您的门票说明..." class="form-control" rows="10"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-2 control-label">
                        <div class="ckbox ckbox-primary pull-right">
                            <input type="checkbox" name="is_full" class="onlyMoney" value="1" id="checkboxPrimary12" style="vertical-align: middle;">
                    ...
                    <div class="col-sm-2">
                        <div class="rdio rdio-default inline-block">
                            <input type="radio" checked="checked" value="1"  name="is_group_once_verificate" disabled="disabled" id="is_group_once_verificate1">
                            <label for="is_group_once_verificate1">是</label>
                        </div>
                        <div class="rdio rdio-default inline-block">
                            <input type="radio" value="0" name="is_group_once_verificate"  disabled="disabled" id="is_group_once_verificate0">
                    ...
                    <div class="col-sm-2">
                        <div class="rdio rdio-default inline-block">
                            <input type="radio" value="1"  name="is_group_once_taken" disabled="disabled" id="is_group_once_taken1">
                            <label for="is_group_once_taken1">是</label>
                        </div>
                        <div class="rdio rdio-default inline-block">
                            <input type="radio" checked="checked" value="0" name="is_group_once_taken" disabled="disabled" id="is_group_once_taken0">
                ...
                <div class="form-group" id="groupShide">
                    ...
                    <div class="col-sm-10">
                        <label class="pull-left" style="margin-top: 5px;">需在入园前&nbsp;</label><input  tag="团队提前预定时间" type="text" class="spinner-day form-control validate[custom[number]]" value="" name="group_scheduled" style="cursor: pointer;cursor: hand;background-color: #ffffff"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/> 天的
                        <div class="bootstrap-timepicker inline-block input-group" style="vertical-align:middle"><input id="timepicker4" type="text" tag="团队提前预定时间" value="" class="form-control" name="group_scheduledtime" style="width:50px"></div>
                        以前购买
                    </div>
                </div><!-- form-group -->
                <div class="form-group" id="groupShowd">
                    ...
                    <div class="col-sm-10">
                        <textarea id="group_des" name='group_description' placeholder="请输入您的门票说明..." class="form-control" rows="10"></textarea>
                    </div>
                </div>
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" placeholder="请输入价格" tag="门市挂牌价"  class="form-control onlyMoney validate[required]" name="listed_price" id="listed_price" />
                    </div>
                </div><!-- form-group -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" placeholder="请输入价格" tag="网络销售价"  class="form-control onlyMoney validate[required]" name="sale_price" id="sale_price" />
                    </div>
                </div><!-- form-group -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="rdio rdio-default inline-block">
                            <input type="radio" checked="checked" value="1"  name="message_open" id="radioDefault3">
                            <label for="radioDefault3">是</label>
                        </div>
                        <div class="rdio rdio-default inline-block">
                            <input type="radio"  value="0"   name="message_open" id="radioDefault4">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="rdio rdio-default inline-block">
                            <input type="radio" checked="checked" value="1"  name="checked_open" id="radioDefault5">
                            <label for="radioDefault5">是</label>
                        </div>
                        <div class="rdio rdio-default inline-block">
                            <input type="radio"  value="0"   name="checked_open" id="radioDefault6">
				...
				<div class="form-group">
                    <label class="col-sm-2 control-label"><div class="pull-right"><span class="text-danger pull-left">*</span>预订游玩日期后 </div></label>
                    <div class="col-sm-10">
						<input type="text" class="spinner-day validate[custom[number]]" name="valid" value="1"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/> 天内有效
                ...
                <div class="form-group">
                    <div class="col-sm-2 control-label">
                        <div class="ckbox ckbox-primary pull-right">
                            <input type="checkbox" name="sms_tem" type="checkbox" value="1"  id="sms-tpl-checkbox" style="vertical-align: middle;">
                    ...
                    <div class="col-sm-10">
                        ...
                        <script>
                            $(document).ready(function() {
                                ...
                                $('#timepicker2').timepicker({showMeridian: false,defaultTIme: false}).on('show.timepicker', function(e) {
                                        $(this).val(e.time.value)
                                    });
                                $('#timepicker4').timepicker({showMeridian: false,defaultTIme: false}).on('show.timepicker', function(e) {
                                        $(this).val(e.time.value)
                                    });
                            });
                        </script>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input class="form-control" type="text" name="partner_product_code" id="partner_product_code"/>
                    </div>
                </div>
                <?php endif;?>
            </div><!-- panel-body -->
...
//    jQuery('#timepicker4').timepicker({showMeridian: false,defaultTIme: false}).val('');
...
<?php endforeach; ?>
    ...
    $(function() {
        ...
        $(document).on('change', 'select.poi', function() {
            ...
            // 设置select2样式，很挫的自定义了方法，设置除了第一行的其他文字颜色
            selectClass($(this), "text-black");
