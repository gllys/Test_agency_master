...
<div class="contentpanel">
    <div class="row">
        <ul class="nav nav-tabs">
            <li class="<?php echo !isset($read_time) || $read_time == '' ? 'active' : ''?>"><a href="/message/notice/view/type/<?php echo $type ?>"><strong>全部</strong></a></li>
            <li class="<?php echo $read_time == '0' ? 'active' : ''?>">
                <a href="/message/notice/view/type/<?php echo $type ?>/read_time/0" style="float:none;" class="btn btn-sm"> 未读
                    <?php if($unread_num > 0): ?><span class="badge" id="unread"><?php echo $unread_num; ?></span><?php endif;?>
                </a>
            </li>
            <li class="<?php echo $read_time == '1' ? 'active' : ''?>">
                <a href="/message/notice/view/type/<?php echo $type ?>/read_time/1" style="float: none;" class="btn btn-sm">已读</a>
            </li>
        <?php if($type == 'advice_close_null'):?>
            <li class="<?php echo $is_allow == 1 ? 'active' : ''?>">
                <a href="/message/notice/view/type/<?php echo $type ?>/is_allow/1" style="float:none;" class="btn btn-sm"> 已发送</a>
            </li>
            <li class="<?php echo $is_allow == 2 ? 'active' : ''?>">
                <a href="/message/notice/view/type/<?php echo $type ?>/is_allow/2" style="float: none;" class="btn btn-sm">已驳回</a>
            </li>
...
<div role="dialog" tabindex="-1" class="modal fade bs-example-modal-lg">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <form method="post" action="/message/notice/preview" target="_blank">
            <div class="modal-header">
                <div id="report"></div>
...
jQuery(document).ready(function() {
    ...
    $('#send_advice').click(function(){
        ...
        $.post('/message/notice/saveadvice',{
                title : title,
...
$('#child_nav a[href="/message/notice/view/type/due/"]').parent().addClass('active').parent().show();
<?php } ?>
</script>