 ...
 */
class Taobao_Request_MaQrcodeCommonCreateRequest
{
	/** 
	...
	public function check()
	{
		...
		Taobao_RequestCheckUtil::checkMaxLength($this->channelName,160,"channelName");
		Taobao_RequestCheckUtil::checkNotNull($this->content,"content");
		Taobao_RequestCheckUtil::checkMaxLength($this->content,256,"content");
		Taobao_RequestCheckUtil::checkMaxLength($this->logo,256,"logo");
		Taobao_RequestCheckUtil::checkNotNull($this->name,"name");
		Taobao_RequestCheckUtil::checkMaxLength($this->name,32,"name");
		Taobao_RequestCheckUtil::checkNotNull($this->size,"size");
		Taobao_RequestCheckUtil::checkMaxValue($this->size,300,"size");
		Taobao_RequestCheckUtil::checkMinValue($this->size,60,"size");
		Taobao_RequestCheckUtil::checkNotNull($this->style,"style");
		Taobao_RequestCheckUtil::checkMaxLength($this->style,50,"style");
		Taobao_RequestCheckUtil::checkNotNull($this->type,"type");
		Taobao_RequestCheckUtil::checkMaxLength($this->type,10,"type");
	}
