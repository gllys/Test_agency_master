...
商城卖家默认付款减库存
	...
	public function check()
	{
		...
		Taobao_RequestCheckUtil::checkMaxLength($this->globalStockCountry,30,"globalStockCountry");
		Taobao_RequestCheckUtil::checkMaxValue($this->num,900000000,"num");
		...
		Taobao_RequestCheckUtil::checkMaxLength($this->propertyAlias,800,"propertyAlias");
		Taobao_RequestCheckUtil::checkMaxLength($this->sellPoint,150,"sellPoint");
