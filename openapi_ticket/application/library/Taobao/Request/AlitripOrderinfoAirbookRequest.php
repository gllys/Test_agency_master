 ...
 */
class Taobao_Request_AlitripOrderinfoAirbookRequest
{
	/** 
	 * 联系人信息对象
	 **/
	...
	public function check()
	{
		...
		Taobao_RequestCheckUtil::checkNotNull($this->bookArrangerInfo,"bookArrangerInfo");
		Taobao_RequestCheckUtil::checkNotNull($this->bookFlightSegmentList,"bookFlightSegmentList");
		Taobao_RequestCheckUtil::checkMaxListSize($this->bookFlightSegmentList,20,"bookFlightSegmentList");
		Taobao_RequestCheckUtil::checkNotNull($this->bookTravelerList,"bookTravelerList");
		Taobao_RequestCheckUtil::checkMaxListSize($this->bookTravelerList,200,"bookTravelerList");
		Taobao_RequestCheckUtil::checkNotNull($this->channelName,"channelName");
		Taobao_RequestCheckUtil::checkNotNull($this->fee,"fee");
		Taobao_RequestCheckUtil::checkNotNull($this->password,"password");
		Taobao_RequestCheckUtil::checkNotNull($this->payment,"payment");
		Taobao_RequestCheckUtil::checkNotNull($this->reservationCode,"reservationCode");
		Taobao_RequestCheckUtil::checkNotNull($this->tax,"tax");
		Taobao_RequestCheckUtil::checkNotNull($this->totalMoney,"totalMoney");
	}
