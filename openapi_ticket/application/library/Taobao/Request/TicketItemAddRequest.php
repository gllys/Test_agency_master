 ...
 */
class Taobao_Request_TicketItemAddRequest
{
	/** 
...
<pre>
{
  "SKU":
	...
	public function check()
	{
		...
		Taobao_RequestCheckUtil::checkNotNull($this->auctionStatus,"auctionStatus");
		Taobao_RequestCheckUtil::checkMaxLength($this->auctionStatus,10,"auctionStatus");
		Taobao_RequestCheckUtil::checkNotNull($this->city,"city");
		Taobao_RequestCheckUtil::checkMaxLength($this->city,20,"city");
		Taobao_RequestCheckUtil::checkNotNull($this->description,"description");
		Taobao_RequestCheckUtil::checkMaxLength($this->description,25000,"description");
		Taobao_RequestCheckUtil::checkMaxValue($this->etcAutoRefund,100,"etcAutoRefund");
		Taobao_RequestCheckUtil::checkMinValue($this->etcAutoRefund,0,"etcAutoRefund");
		Taobao_RequestCheckUtil::checkMaxValue($this->etcOverduePay,100,"etcOverduePay");
		Taobao_RequestCheckUtil::checkMinValue($this->etcOverduePay,0,"etcOverduePay");
		Taobao_RequestCheckUtil::checkNotNull($this->image1,"image1");
		Taobao_RequestCheckUtil::checkMaxLength($this->listTime,20,"listTime");
		Taobao_RequestCheckUtil::checkNotNull($this->productId,"productId");
		Taobao_RequestCheckUtil::checkNotNull($this->prov,"prov");
		Taobao_RequestCheckUtil::checkMaxLength($this->prov,20,"prov");
		Taobao_RequestCheckUtil::checkNotNull($this->skus,"skus");
		Taobao_RequestCheckUtil::checkNotNull($this->subStockAtBuy,"subStockAtBuy");
