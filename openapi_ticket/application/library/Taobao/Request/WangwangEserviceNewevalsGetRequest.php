 ...
 */
class Taobao_Request_WangwangEserviceNewevalsGetRequest
{
	/** 
...
结束时间不能小于开始时间，结束时间和开始时间的间隔不能超过7天
	...
	public function check()
	{
		...
		Taobao_RequestCheckUtil::checkNotNull($this->queryIds,"queryIds");
		Taobao_RequestCheckUtil::checkMaxListSize($this->queryIds,30,"queryIds");
	}
