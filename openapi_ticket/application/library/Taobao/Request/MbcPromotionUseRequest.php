 ...
 */
class Taobao_Request_MbcPromotionUseRequest
{
	/** 
	 * 实际金额单位(分)
	 **/
...
promotion_type+outer_no 唯一
	...
	public function check()
	{
		...
		Taobao_RequestCheckUtil::checkNotNull($this->actualFee,"actualFee");
		Taobao_RequestCheckUtil::checkNotNull($this->discountFee,"discountFee");
		Taobao_RequestCheckUtil::checkNotNull($this->outerNo,"outerNo");
		Taobao_RequestCheckUtil::checkNotNull($this->promotionId,"promotionId");
		Taobao_RequestCheckUtil::checkNotNull($this->promotionType,"promotionType");
		Taobao_RequestCheckUtil::checkNotNull($this->totalFee,"totalFee");
		Taobao_RequestCheckUtil::checkNotNull($this->useTime,"useTime");
