 ...
 */
class Taobao_Request_VmarketEticketReverseRequest
{
	/** 
	...
	public function check()
	{
		...
		Taobao_RequestCheckUtil::checkNotNull($this->consumeSecialNum,"consumeSecialNum");
		Taobao_RequestCheckUtil::checkNotNull($this->orderId,"orderId");
		Taobao_RequestCheckUtil::checkNotNull($this->reverseCode,"reverseCode");
		Taobao_RequestCheckUtil::checkNotNull($this->reverseNum,"reverseNum");
		Taobao_RequestCheckUtil::checkNotNull($this->token,"token");
	}
