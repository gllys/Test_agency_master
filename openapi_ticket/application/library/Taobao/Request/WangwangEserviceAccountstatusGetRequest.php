 ...
 */
class Taobao_Request_WangwangEserviceAccountstatusGetRequest
{
	/** 
	 * 的起始时间。</br>
...
3. 由于后端依然是顺序请求，所以该接口的响应时长是会随uid的数量线性增长，即uid数量越多，调用时间越长。请合理使用<br /> 支持最大长度为：1920<br /> 支持的最大列表长度为：1920
	...
	public function check()
	{
		...
		Taobao_RequestCheckUtil::checkNotNull($this->btime,"btime");
		Taobao_RequestCheckUtil::checkMaxLength($this->btime,19,"btime");
		Taobao_RequestCheckUtil::checkNotNull($this->etime,"etime");
		Taobao_RequestCheckUtil::checkMaxLength($this->etime,19,"etime");
		Taobao_RequestCheckUtil::checkNotNull($this->uid,"uid");
		Taobao_RequestCheckUtil::checkMaxListSize($this->uid,30,"uid");
		Taobao_RequestCheckUtil::checkMaxLength($this->uid,1920,"uid");
	}
