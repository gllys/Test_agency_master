 ...
 */
class Taobao_Request_TmallProductBooksAddRequest
{
	/** 
...
2. 位数限定：13位、开头数字限定： 9787开头<br /> 支持最大长度为：13<br /> 支持的最大列表长度为：13
	...
	public function check()
	{
		...
		Taobao_RequestCheckUtil::checkNotNull($this->appInfo,"appInfo");
		Taobao_RequestCheckUtil::checkMaxLength($this->appInfo,40,"appInfo");
		Taobao_RequestCheckUtil::checkNotNull($this->author,"author");
		Taobao_RequestCheckUtil::checkMaxLength($this->author,80,"author");
		Taobao_RequestCheckUtil::checkMaxLength($this->authorArea,80,"authorArea");
		Taobao_RequestCheckUtil::checkNotNull($this->barCode,"barCode");
		Taobao_RequestCheckUtil::checkMaxLength($this->barCode,20,"barCode");
		Taobao_RequestCheckUtil::checkNotNull($this->bookBind,"bookBind");
		Taobao_RequestCheckUtil::checkMaxLength($this->bookBind,10,"bookBind");
		Taobao_RequestCheckUtil::checkMaxLength($this->catalog,8000,"catalog");
		Taobao_RequestCheckUtil::checkNotNull($this->categoryId,"categoryId");
		Taobao_RequestCheckUtil::checkMaxListSize($this->categoryId,40,"categoryId");
		Taobao_RequestCheckUtil::checkMaxLength($this->chinaClassifyNo,30,"chinaClassifyNo");
		Taobao_RequestCheckUtil::checkMaxLength($this->cip,50,"cip");
		Taobao_RequestCheckUtil::checkMaxLength($this->commentator,40,"commentator");
		Taobao_RequestCheckUtil::checkNotNull($this->customId,"customId");
		Taobao_RequestCheckUtil::checkNotNull($this->deputyName,"deputyName");
		Taobao_RequestCheckUtil::checkMaxLength($this->deputyName,150,"deputyName");
		Taobao_RequestCheckUtil::checkMaxLength($this->drawor,40,"drawor");
		Taobao_RequestCheckUtil::checkMaxLength($this->editor,40,"editor");
		Taobao_RequestCheckUtil::checkMaxLength($this->graphor,40,"graphor");
		Taobao_RequestCheckUtil::checkNotNull($this->isbn,"isbn");
		Taobao_RequestCheckUtil::checkMaxLength($this->isbn,13,"isbn");
		Taobao_RequestCheckUtil::checkMaxLength($this->narrator,40,"narrator");
		Taobao_RequestCheckUtil::checkMaxLength($this->partName,150,"partName");
		Taobao_RequestCheckUtil::checkMaxLength($this->plottor,40,"plottor");
		Taobao_RequestCheckUtil::checkNotNull($this->price,"price");
		Taobao_RequestCheckUtil::checkMaxLength($this->price,40,"price");
		Taobao_RequestCheckUtil::checkMaxLength($this->publishCompany,80,"publishCompany");
		Taobao_RequestCheckUtil::checkMaxLength($this->reginYear,10,"reginYear");
		Taobao_RequestCheckUtil::checkMaxLength($this->scholisat,40,"scholisat");
		Taobao_RequestCheckUtil::checkMaxLength($this->seriesBooksName,150,"seriesBooksName");
		Taobao_RequestCheckUtil::checkMaxLength($this->spuImg,150,"spuImg");
		Taobao_RequestCheckUtil::checkMaxLength($this->summary,5000,"summary");
		Taobao_RequestCheckUtil::checkMaxLength($this->translator,40,"translator");
	}
