 ...
 * @author  mosen
 */
class Base_Controller_OtaNew extends Base_Controller_Abstract
{
        ...
        if($need_sign){
            ...
            if (!$sign) {
                Lang_Msg::output(array(
                    'code' => 400,
                    'message' => Lang_Msg::getLang('ERROR_SIGN_1'),
                    'result' => array(),
            ...
            if (!$debugMode && (!$this->body['timestamp'] || $this->now > $this->timeout + $this->body['timestamp'])) {
                Lang_Msg::output(array(
                    'code' => 400,
                    'message' => '请求超时',
                    'result' => array(),
            ...
            if (!$debugMode && $sign != $tmpSign) {
                ...
                Lang_Msg::output(array(
                    'code' => 400,
                    'message' => Lang_Msg::getLang('ERROR_SIGN_2'),
                    'result' => array(),
    ...
    public function userAuth($sign) {
        ...
        if (empty($this->userinfo)) {
            if(!$account || !$pwd) {
                Lang_Msg::output(array(
                    'code' => 400,
                    'message' => Lang_Msg::getLang('ERROR_SIGN_3'),
                    'result' => array(),
                ));
            }
