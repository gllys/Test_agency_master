...
{	
	...
	public function getDbConnection()
	{
		...
		if(self::$db instanceof CDbConnectionExt) self::$db->shardValue = $this->shardValue;
	...
	public function tableName(){
		if($this->shardingType==null && !$this->tableName){
			...
			if($shardValue===null) return $this->tableName;
...
//			return $this->_shardValue;
	...
	protected function getCache(){
		...
		if(!isset(Yii::app()->$cacheId)) return null;
	...
	public function findByPk($pk, $condition='', $params=array()){
		if($this->tableSchema->primaryKey == $this->shardKey) $this->setShardValue($pk);
		if($this->cache!==null){
