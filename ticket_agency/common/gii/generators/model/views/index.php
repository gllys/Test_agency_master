...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
	...
	<div class="row sticky">
		...
		<div class="tooltip">基本数据库连接ID</div>
		<?php echo $form->error($model,'connectionId'); ?>
	</div>
	<div class="row model-class">
		<?php echo $form->labelEx($model,'isGlobal'); ?>
		<?php echo $form->checkBox($model,'isGlobal', array('size'=>65)); ?>
		<div class="tooltip">是否全局库（不分平台）</div>
		<?php echo $form->error($model,'tablePrefix'); ?>
	</div>
	<div class="row">
