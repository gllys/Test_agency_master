...
//            }
// //判断数据库是否提交
//            if(isset($_POST['assword']) && !empty($_POST['assword'])){
//                $info = $_POST;
//                $password = trim($info['old']);
//               if(!password_verify($password, $result['password'])){
//                   // 旧密码不正确
//                  // echo json_encode(array('errors'=>1,'msg'=>"原始密码错误！"));
//                   echo json_encode(array('errors'=>array('msg'=>"原始密码错误！")));
//               }else{
//                  // 修改数据库密码
//                    $results->password =password_hash($info['assword'], PASSWORD_BCRYPT, array('cost'=>8));
//                    if($results->save()){
//                        echo 1;
//                      // echo json_encode(array('errors'=>0,'msg'=>"原始密码错误！"));
//                     }else{
//                        // echo json_encode(array('errors'=>1,'msg'=>"修改密码错误！"));
