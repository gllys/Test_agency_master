<?php
$this->breadcrumbs = array('控制台','摘要统计');
?>
	...
	<div class="col-md-4">
		<div class="panel panel-success-alt noborder">
			<div class="panel-heading noborder">
				...
				<!-- panel-btns -->
				<div class="panel-icon"><i class="fa fa-bank" style="padding-left: 11px"></i></div>
				<div class="media-body">
					<h5 class="md-title nomargin">账户资金</h5>

					<h1 class="mt5"><i class="fa fa-cny"></i>8,102.32</h1>
				</div>
				<!-- media-body -->
				<hr>
				<div class="clearfix mt20">
					<div class="pull-left">
						<h5 class="md-title nomargin">账户余额</h5>
						<h4 class="nomargin"><i class="fa fa-cny"></i>29,009.17</h4>
					</div>
					<div class="pull-right">
						<h5 class="md-title nomargin">冻结</h5>
						<h4 class="nomargin"><i class="fa fa-cny"></i>99,103.67</h4>
					</div>
				</div>
	...
	<div class="col-md-4">
		<div class="panel panel-primary noborder">
			<div class="panel-heading noborder">
				...
				<!-- panel-btns -->
				<div class="panel-icon"><i class="fa fa-credit-card" style="padding-left: 11px"></i></div>
				<div class="media-body">
					<h5 class="md-title nomargin">应付账款</h5>
	...
	<div class="col-md-4">
		<div class="panel panel-success-head widget-todo">
			<div class="panel-heading">
				<div class="pull-right">
					<a title="" data-toggle="tooltip" class="tooltips mr5" href="#" data-original-title=""><i
							class="glyphicon glyphicon-cog"></i></a>
					<a title="" data-toggle="tooltip" class="tooltips" id="addnewtodo" href="#"
					   data-original-title=""><i class="glyphicon glyphicon-plus"></i></a>
				</div>
				<!-- panel-btns -->
			...
			<div class="panel panel-primary">
				...
				<div id="collapseThree2" class="panel-collapse collapse">
					<div class="panel-body">
						...
						<p>Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird
