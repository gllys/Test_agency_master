                ...
                <div class="panel-body">
                    ...
                    <form action="" method="post" id="login-form">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="reset_account" name="UResetForm[tnuocca]"
	                    ...
	                    <div class="input-group">
		                    ...
		                    <input type="text" class="form-control" id="reset_code" name="UResetForm[edoc]"
		                           autocomplete="off">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" id="reset_password" name="UResetForm[drowssap]"
                                   autocomplete="off"/>
                        </div>
                        <!-- input-group -->
	                    <div class="input-group mb15">
