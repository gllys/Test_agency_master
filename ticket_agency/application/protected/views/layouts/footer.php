...
<script src="<?php echo Yii::app()->versionUrl->changeUrl('/js/jquery-ui-1.10.3.min.js') ?>"></script>
...
<script src="<?php echo Yii::app()->versionUrl->changeUrl('/js/message.js') ?>"></script>
...
<script src="<?php echo Yii::app()->versionUrl->changeUrl('/js/repass.js') ?>"></script>
