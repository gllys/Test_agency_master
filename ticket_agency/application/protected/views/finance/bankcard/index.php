            ...
            <div class="modal-content">
                <form id="bank_alipay">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="position:static">
                                <input type="text" class="form-control validate[required]" name="account">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" id="add_bank_alipay">添加</button>
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal fade bs-example-modal-lg1" id="edit_alipay" tabindex="-1" role="dialog"></div>

<script type="text/javascript">
    function edit(id) {
        $('#bank_edit').html();
        $.get('/finance/bankcard/edit/?id=' + id, function(data) {
            $('#bank_edit').html(data);
        });
    }
    function editalipay(id) {
        $('#edit_alipay').html();
        $.get('/finance/bankcard/editalipay/?id=' + id, function(data) {
            $('#edit_alipay').html(data);
        });
    }
</script>
...
// Color Picker Flat Mode
        ...
        $('#add_bank_alipay').click(function() {
