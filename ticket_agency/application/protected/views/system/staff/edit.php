                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="" tag="账号" class="form-control" name="account" value="<?php echo $user['account']; ?>" readonly/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" placeholder="" tag="密码" class="form-control  validate[minSize[6],maxSize[16]]" onclick="this.name='password'" />
                                    </div>
                                </div>
                                <!-- form-group -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="" tag="员工姓名" class="form-control validate[required]" name="name" value="<?php echo $user['name']; ?>"/>
                                    </div>
                                </div>
                                <!-- form-group -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="" maxlength="11" tag="手机号码" class="form-control validate[required,custom[phone]]" name="mobile" value="<?php echo $user['mobile']; ?>"/>
                                    </div>
                                </div>
                                <!-- form-group -->
                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                    <?php if(!$user['is_super']): ?>
                                                        <select class="select2 col-sm-12 form-control validate[required]" tag="角色" data-prompt-position="topRight:250" id="role_id" placeholder="Choose One" name="role_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <select class="select2 form-control validate[required]" tag="角色状态" data-placeholder="Choose One" id="status" name="status">
