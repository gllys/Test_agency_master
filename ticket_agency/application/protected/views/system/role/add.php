<?php
$this->breadcrumbs = array('系统管理', '添加角色');
?>
                ...
                <div class="panel-body nopadding">
                    ...
                    <form id="form" class="form-horizontal form-bordered" action="#" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">					  					  	
                                <input name="name" type="text" maxlength="15"  class="form-control validate[required]" placeholder="">		
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">*角色说明:</label>
                            <div class="col-sm-4">					  					  	
                                <textarea name="description" class="form-control validate[required,maxSize[50]]" rows="5"></textarea>		
                            </div>
                        </div>
