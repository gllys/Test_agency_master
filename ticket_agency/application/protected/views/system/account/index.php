                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" autocomplete="off" tag="原密码" id="old_pass" name="user[oldpass]" class="validate[required,minSize[6],maxSize[16]] error form-control">
                                    </div>
                                </div>
                                <!-- form-group -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" autocomplete="off" id="password" tag="新密码" name="user[password]" class="validate[required,minSize[6],maxSize[16]] form-control error">
                                    </div>
                                </div>
                                <!-- form-group -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" autocomplete="off" tag="确认新密码" name="user[confirm_password]" class="validate[required,equals[password],minSize[6],maxSize[16]] form-control error">
                                    </div>
                                </div>
                                <!-- form-group -->
