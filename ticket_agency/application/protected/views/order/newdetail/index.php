        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php if($detail['status'] == 'unpaid'):?>
                    ...
                    <p style="color:red">1、任务单无需支付,一经确认,无法再次修改;2、确认任务单后,请与供应商联系索取任务单;</p>
                    <div style="text-align:center">
                    	<button class="btn btn-default" onclick="paid(<?php echo $detail['id']?>)">确认任务单</button>
                    	<button class="btn btn-default" onclick="cancel(<?php echo $detail['id']?>)">取消任务单</button>
                    </div>
                <?php elseif($detail['status'] == 'paid'):?>
                	<div style="text-align:center">
                    	<button class="btn btn-success" disabled="disabled">任务单已确认</button>
                    </div>
