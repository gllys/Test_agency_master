<?php
$this->breadcrumbs = array('门票管理', '团队预定');
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <input class="form-control" type="text" value="<?php echo isset($_GET['jqname'])?$_GET['jqname']:""; ?>" placeholder="请输入门票名称" style="width:300px" name="jqname">
                            </div>
                            <button type="button" class="btn btn-primary mr5 btn-sm" id="repass_sub">搜索</button>
                        </td>
            ...
            <table class="table table-bordered mb30" id="tablecss">
                <thead>
                    <tr>
	                    ...
	                    <th style="text-align:left;width:15%">景区</th>
                        <th style="text-align:left;width: 22%">门票名称</th>
                        <th style="text-align:left">供应商</th>
	                    <th style="width:13%">游玩日期</th>
                        <!--th>游玩星期</th-->
	                    <th style="text-align:right;width:5%">销售价</th>
	                    <th style="text-align:right;width:5%">挂牌价</th>
	                    <th style="text-align:right;width:5%">团队价</th>
                        <th>最低订购数</th>
                ...
                ?> 
                    <tr>
                        ...
                        <td style="text-align: right" class="text-success"><?php echo number_format($model['group_price'],2);?></td>
                        <td><?php echo $model['mini_buy'];?></td>
