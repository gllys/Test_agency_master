...
class Controller extends CController {
    ...
    public function accessRules() {
        return array(
            array('allow',
                'actions' => array('reset', 'register', 'login', 'error', 'pre', 'qr', 'smsCode', 'captcha', 'upyunAgent','api'),
                'users' => array('*'),
            ),
    ...
    protected function allowedAccess($access) {
        $allows = array('order.Payments.Api','order.Payments.Completed','finance.Platform.Api',  'Site.Register', 'Site.Pre', 'Site.SmsCode', 'Site.Reset', 'Site.Login', 'Site.Error', 'Site.Logout', 'Site.Captcha', 'Site.Index', 'Site.UpyunAgent');
    ...
    public function success($message, $next_url, $next_title) {
        $this->notification($message, $next_url, $next_title, 'success');
    }

    public function fail($message, $next_url, $next_title) {
        $this->notification($message, $next_url, $next_title, 'fail');
    }
