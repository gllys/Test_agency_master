 ...
 */
class UserToken extends UActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('uid, expire, create_time, update_time, last_updated_source', 'numerical', 'integerOnly'=>true),
			array('token', 'length', 'max'=>100),
			array('created_at, deleted_at', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, uid, token, expire, create_time, update_time, created_at, updated_at, deleted_at, last_updated_source', 'safe', 'on'=>'search'),
		);
	}
