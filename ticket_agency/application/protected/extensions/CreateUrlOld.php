...
//                continue;
    ...
    private function checkAuth($item) {
        ...
        if (in_array($item['params']['href'], $permissions)) {
            return true;
        }
        return false;
    }
    ...
    public $titles = array(
        //array('params' => array('class' => 'fa fa-fw fa-home'), 'content' => '首页'),
    ...
    public $lists = array(
        /* array(
          array('auth' => '', 'paramIcos' => array("class" => "fa fa-home"), 'params' => array('href' => '/'), 'content' => '控制台'),
