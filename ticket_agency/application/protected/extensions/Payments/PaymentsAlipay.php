...
final class PaymentsAlipay
{
	...
	//卖家账号
	private $seller_email       = 'huilian@ihuilian.com';
	...
	public function dopay($payment, $orderInfo, &$msg)
	{
		...
		$this->notify_url = Yii::app()->basePath.'/api/alipay/async_callback.html';
		$this->return_url = Yii::app()->basePath.'/api/alipay/sync_callback.html';
	...
	public function syncCallback()
	{
		...
		if (!$ret['channel'])
			...
			header("Location:".base_url()."/money_log.html");
